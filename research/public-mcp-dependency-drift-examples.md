# Five public examples of mutable MCP package references
...
| --- | --- | --- | --- |
| dotCMS/core | [`.mcp.json`](https://github.com/dotCMS/core/blob/f5a4d4a92f5af10bdbd4146d2f744e2803faba60/.mcp.json) | `chrome-devtools-mcp@latest`, bare `@primeng/mcp`, bare `@angular/cli` | No issue opened in this pass |
...
| commercetools UI Kit | [`.mcp.json`](https://github.com/commercetools/ui-kit/blob/62ca335b629de087f574af71869d68cbd3bd004c/.mcp.json) | `@upstash/context7-mcp@latest`, `@playwright/mcp@latest`, bare `@modelcontextprotocol/server-sequential-thinking` | No issue opened in this pass |
